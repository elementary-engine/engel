...
impl Transform {
    ...
    pub fn is_absolute(&self) -> bool {
        matches!(self, Transform::Global(_) | Transform::Calculated { local: None, .. })
    }
...
///
/// A transformation is a combination of translation (aka. position), skew and
/// scale **or** translation and rotation; implemented as a column-major matrix
/// in the following form: **[a c e]** - indices [0 2 4]
/// **[b d f]** - indices [1 3 5]
/// **[0 0 1]** - only theoretical / does not really exist. Logically it is
/// always [0 0 1].
...
/// The order in which you multiplicate matters (you are multiplicating
/// matrices)
...
impl Mul<(Real, Real)> for TransformMatrix {
